...
*   **🛠️ User Dashboard:** Students can track their study progress and see completed topics.
*   **🛠️ Admin Dashboard:** A control panel for contributors to manage the curriculum and upload new notes.
...
*   **Animations:** [Framer Motion](https://www.framer.com/motion/) — For those buttery smooth transitions. 🥞
*   **Fonts:** A curated collection of custom typography (Boska, Clash Display, etc.) to give that premium feel.
...
│   │   ├── admin/              # 🛠️ Admin Dashboard Area
│   │   │   ├── layout.tsx      # 🏗️ Admin-specific layout
│   │   │   ├── page.tsx        # 📄 Admin main dashboard page
│   │   │   ├── branches/       # 🌿 Manage academic branches
│   │   │   ├── courses/        # 📚 Manage courses
│   │   │   ├── semester/       # 🗓️ Manage individual semesters
